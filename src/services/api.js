...
export const tripAPI = {
  getHistory: (days = 30, filters = {}) => api.get('/parent/trip-history', { params: { days, ...filters } }),
  getUpcoming: (days = 1, filters = {}) => api.get('/parent/upcoming-trips', { params: { days, ...filters } }),
};
...
export const messageAPI = {
  ...
  reportAbsence: d => api.post('/messages/absence', d),
  getMyDrivers: () => api.get('/messages/my-drivers'),
  getNotifications: () => api.get('/messages/notifications'),
  deleteNotification: id => api.delete(`/messages/notifications/${id}`),
  clearNotifications: () => api.delete('/messages/notifications'),
};
